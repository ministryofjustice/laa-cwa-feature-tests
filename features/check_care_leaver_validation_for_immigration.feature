Feature: Check Care Leaver Validation for Immigration claims
  ...
  Scenario Outline: Reject invalid care leaver Asylum claims
    ...
    Examples:
      ...
      | 422     | IACA:IFRA |          | 1234567AB | 01/11/19        | PA00140 | AP00198 | It has been indicated that the matter has Exceptional Case Funding (as an ECF Reference has been recorded in the outcome details). The PA and AP must be populated with the values: ECF Matter (PA20000/AP20000).                                      |
      | 423     | IACA:IFRA |          |           | 01/11/19        | PA20000 | AP20000 | The PA (PA20000) and/or AP (AP20000) fields have been populated with ECF Matter. This value can only be used if the ECF Reference field is also populated.                                                                                             |
      | 424     | IAXL:IOUT |          |           | 01/11/19        | PA00140 | AP00198 | The combination of reporting codes can only be used for cases started on or after 01-APR-2013 if an Exceptional Case Funding reference is recorded or if an exemption criterion has been satisfied and this has been indicated in the outcome details. |
      | 425     | IAXL:IOUT |          | 1234567AB | 01/11/19        | PA00140 | AP00198 | It has been indicated that the matter has Exceptional Case Funding (as an ECF Reference has been recorded in the outcome details). The PA and AP must be populated with the values: ECF Matter (PA20000/AP20000).                                      |
      | 426     | IAXL:IOUT |          |           | 01/11/19        | PA20000 | AP20000 | The combination of reporting codes can only be used for cases started on or after 01-APR-2013 if an Exceptional Case Funding reference is recorded or if an exemption criterion has been satisfied and this has been indicated in the outcome details. |
      | 427     | IACA:IASY |          | 1234567AB | 01/11/19        | PA00140 | AP00198 | It has been indicated that the matter has Exceptional Case Funding (as an ECF Reference has been recorded in the outcome details). The PA and AP must be populated with the values: ECF Matter (PA20000/AP20000).                                      |
      | 428     | IACA:IASY |          |           | 01/11/19        | PA20000 | AP20000 | The PA (PA20000) and/or AP (AP20000) fields have been populated with ECF Matter. This value can only be used if the ECF Reference field is also populated.                                                                                             |
      | 429     | IMLB:IEUL |          |           | 01/11/19        | PA00140 | AP00198 | The combination of reporting codes can only be used for cases started on or after 01-APR-2013 if an Exceptional Case Funding reference is recorded or if an exemption criterion has been satisfied and this has been indicated in the outcome details. |
      | 430     | IMLB:IEUL |          | 1234567AB | 01/11/19        | PA00140 | AP00198 | It has been indicated that the matter has Exceptional Case Funding (as an ECF Reference has been recorded in the outcome details). The PA and AP must be populated with the values: ECF Matter (PA20000/AP20000).                                      |
      | 431     | IMLB:IEUL |          |           | 01/11/19        | PA20000 | AP20000 | The combination of reporting codes can only be used for cases started on or after 01-APR-2013 if an Exceptional Case Funding reference is recorded or if an exemption criterion has been satisfied and this has been indicated in the outcome details. |
  ...
  Scenario Outline: Add valid care leaver Asylum claims
    ...
    Examples:
      ...
      | 435     | IMLB:IEUL |          | 1234567AB | 01/11/19        | PA20000 | AP20000 |
      | 436     | IACA:IFRA |          | 1234567AB | 01/11/19        | PA20000 | AP20000 |
      | 437     | IAXL:IOUT |          | 1234567AB | 01/11/19        | PA20000 | AP20000 |
      | 438     | IACA:IASY |          | 1234567AB | 01/11/19        | PA20000 | AP20000 |
      | 439     | IACA:IFRA |          |           | 01/11/19        | PA00140 | AP00198 |
      | 440     | IACA:IASY |          |           | 01/11/19        | PA00140 | AP00198 |
