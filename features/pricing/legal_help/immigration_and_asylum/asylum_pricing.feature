Feature: Pricing for Asylum claims
  ...
  Scenario: Bulkload Civil Asylum outcomes with additional fees, with EXEMPTION_CRITERIA_SATISFIED: <NONE>
    ...
    Escape fee flag: (PROFIT_COST + COUNSEL_COST) > (3 * Base fee £627)
    ...
    And the following outcomes are bulkloaded:
      ...
      | 8 | 010419/008 | 01/04/2019      | 1882        | 0            | Y             | Y                   | 2                     | 2         | 3              | <blank>                      | 100                  | 20                |
    When user confirms the submission
    And user is on the pricing outcome details page
    Then user should see the following outcomes:
      | # | UFN        | Value      | Escape Fee |
      | 1 | 010419/001 | £ 627.00   | N          |
      | 2 | 010419/002 | £ 752.40   | N          |
      | 3 | 010419/003 | £ 1,114.80 | N          |
      | 4 | 010419/004 | £ 1,501.20 | N          |
      | 5 | 010419/005 | £ 1,899.60 | N          |
      | 6 | 010419/006 | £ 2,223.60 | N          |
      | 7 | 010419/007 | £ 2,343.60 | N          |
      | 8 | 010419/008 | £ 2,343.60 | Y          |
