Feature: PROJ outcome pricing
  Rules: The following mag court fee schemes are used with the PROJ claim code
...
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 01-JAN-1995 to 02-OCT-2011
  ...
  | PROJ        |                |                  | 611.15      | 010195/001 | 02-JAN-1995         | C1013          |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MAGISTRATE_COURT_FEE_LAR
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 03-OCT-2011 to 19-MAR-2014

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id    |
  | PROJ        | 03-OCT-2011    | 1EW              | 517.05      | 031011/001 | 04-OCT-2011         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MAGISTRATE_CFEE_LAR2
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 20-MAR-2014 to 30-JUN-2015

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 20-MAR-2014    | 1EW              | 471.81      | 200314/001 | 21-MAR-2014         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MCOURT_FEE_CFC_2015
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 01-JUL-2015 to 31-MAR-2016

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 01-JUL-2015    | 1EW              | 426.57      | 010715/001 | 02-JUL-2015         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MC_FEE_REV_PRE_JULY_2015
Scenario: Manually enter PROJ outcomes using the mag court fee scheme from 01-APR-2016

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 01-APR-2016    | 1EW              | 471.81      | 010416/001 | 02-APR-2016         | C1013          | 1234567890 |
  Then the outcome saves successfully
...
#"""
#The fee you have entered is not valid for Category 1: Either Way / PROJ matters. Please enter a valid fee in the profit costs field.
#"""
...
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 03-OCT-2011 to 19-MAR-2014
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id    |
  | PROJ        | 03-OCT-2011    | 1EW              | 518.05      | 031011/002 | 04-OCT-2011         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROJ matters. Please enter a valid fee in the profit costs field.
  """
...
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 20-MAR-2014 to 30-JUN-2015
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 20-MAR-2014    | 1EW              | 472.81      | 200314/002 | 21-MAR-2014         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROJ matters. Please enter a valid fee in the profit costs field.
  """
...
Scenario: Manually enter PROJ outcomes using the mag court fee scheme 01-JUL-2015 to 31-MAR-2016
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 01-JUL-2015    | 1EW              | 427.57      | 010715/002 | 02-JUL-2015         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROJ matters. Please enter a valid fee in the profit costs field.
  """
...
Scenario: Manually enter PROJ outcomes using the mag court fee scheme from 01-APR-2016
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROJ        | 01-APR-2016    | 1EW              | 472.81      | 010416/002 | 02-APR-2016         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROJ matters. Please enter a valid fee in the profit costs field.
  """
