Feature: PROK outcome pricing
  Rules: The following mag court fee schemes are used with the PROK claim code
...
Scenario: Manually enter PROK outcomes using the mag court fee scheme 01-JAN-1995 to 02-OCT-2011
  ...
  | PROK        |                |                  | 484.60      | 010195/001 | 02-JAN-1995         | C1013          |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MAGISTRATE_COURT_FEE_LAR
Scenario: Manually enter PROK outcomes using the mag court fee scheme 03-OCT-2011 to 19-MAR-2014

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id    |
  | PROK        | 03-OCT-2011    | 1EW              | 272.56      | 031011/001 | 04-OCT-2011         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MAGISTRATE_CFEE_LAR2
Scenario: Manually enter PROK outcomes using the mag court fee scheme 20-MAR-2014 to 30-JUN-2015

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROK        | 20-MAR-2014    | 1EW              | 248.71      | 200314/001 | 21-MAR-2014         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MCOURT_FEE_CFC_2015
Scenario: Manually enter PROK outcomes using the mag court fee scheme 01-JUL-2015 to 31-MAR-2016

  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROK        | 01-JUL-2015    | 1EW              | 224.86      | 010715/001 | 02-JUL-2015         | C1013          | 1234567890 |
  Then the outcome saves successfully

@valid @crime_lower @delete_outcome_before @XXLSC_MC_FEE_REV_PRE_JULY_2015
Scenario: Manually enter PROK outcomes using the mag court fee scheme from 01-APR-2016
...
Scenario: Manually enter PROK outcomes using the mag court fee scheme 03-OCT-2011 to 19-MAR-2014
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id    |
  | PROK        | 03-OCT-2011    | 1EW              | 273.56      | 031011/002 | 04-OCT-2011         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROK matters. Please enter a valid fee in the profit costs field.
  """
...
Scenario: Manually enter PROK outcomes using the mag court fee scheme 20-MAR-2014 to 30-JUN-2015
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROK        | 20-MAR-2014    | 1EW              | 249.71      | 200314/002 | 21-MAR-2014         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROK matters. Please enter a valid fee in the profit costs field.
  """
...
Scenario: Manually enter PROK outcomes using the mag court fee scheme 01-JUL-2015 to 31-MAR-2016
  ...
  When user adds outcomes for "Crime Lower" "Criminal Proceedings" with fields like this:
  | matter_type | rep_order_date | standard_fee_cat | profit_cost | ufn        | work_concluded_date | police_station | maat_id |
  | PROK        | 01-JUL-2015    | 1EW              | 225.86      | 010715/002 | 02-JUL-2015         | C1013          | 1234567890 |
  Then the outcome does not save and gives an error containing:
  """
  The fee you have entered is not valid for Category 1: Either Way / PROK matters. Please enter a valid fee in the profit costs field.
  """
