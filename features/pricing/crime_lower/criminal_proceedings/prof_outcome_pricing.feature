Feature: PROF outcome pricing
  Rules: The following mag court fee schemes are used with the PROF claim code
...
#    Then the outcome saves successfully
  ...
  Scenario: Manually enter PROF outcomes using the mag court fee scheme 03-OCT-2011 to 19-MAR-2014
    ...
    """
    The fee you have entered is not valid for Category 1: Either Way / PROF matters. Please enter a valid fee in the profit costs field.
    """
