Feature: Pricing for Assessment Meeting claims
  ...
  Scenario: Claims priced with: Unit price
    ...
    Then user should see the following outcomes:
      ...
      | 3 | 151110/003 | £ 357.00   | Unit price for MEDI:MDAS £168 for start/end date 1 mediation session 2 legally aided, outcome code "P" addiional payment(£189) priced at unit price + disbursement amount +  disbursement vat + addiional payment = £168 + £0 + £0 + £189                                                  |
