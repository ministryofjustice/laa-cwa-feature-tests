Feature: Validate age is below 18 for UASC claim field
  ...
  Scenario Outline: validate UASC ASYLUM case where case start date is < 18 years after client DOB
    ...
    And the following outcomes are bulkloaded:
      ...
      |     107 |                | IAXL:IUAS   | IE            |        15/11/10 | PA00136          | AP00137      |            Test |         Person |            17/11/92 | 17111992/T/PERS |
  ...
  Scenario Outline: validate UASC ASYLUM case where case start date is = 18 years after client DOB
    ...
    And the following errors:
      ...
      | IAXC:IUAS                   | 151110/109 | VALIDATION21   | You cannot submit a claim using matter type combination IAXC:IUAS or IAXL:IUAS if your client was aged 18 or over when the case started. |
      | IAXL:IUAS                   | 151110/110 | VALIDATION21   | You cannot submit a claim using matter type combination IAXC:IUAS or IAXL:IUAS if your client was aged 18 or over when the case started. |
  ...
  Scenario Outline: validate UASC ASYLUM case where case start date is > 18 years after client DOB
    ...
    And the following errors:
      | Matter Type / Stage Reached | UFN        | Error Type     | Description                                                                                                                              |
      | IAXC:IUAS                   | 151110/111 | VALIDATION21   | You cannot submit a claim using matter type combination IAXC:IUAS or IAXL:IUAS if your client was aged 18 or over when the case started. |
      | IAXL:IUAS                   | 151110/112 | VALIDATION21   | You cannot submit a claim using matter type combination IAXC:IUAS or IAXL:IUAS if your client was aged 18 or over when the case started. |
