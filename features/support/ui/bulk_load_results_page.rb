...
class BulkLoadResultsPage < SitePrism::Page
  ...
  sections :errors, BulkLoadResultsErrorsSection, :xpath, '/html/body/form/span[2]/div[1]/div[3]/div[2]/span[3]/table/tbody/tr[2]/td/table/tbody/tr/following-sibling::tr[position() > 0]'
